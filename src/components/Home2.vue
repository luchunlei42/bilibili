    ...
    <el-container>
      ...
      <el-main>
        ...
        <div class="b-wrap tab_main">
          ...
          <div class="tab_left">
            <ul>
              <li class="tab_left_item" v-for="(item, i) in tabsLeftList" :key="i">
                <a href="#">
          ...
          <div class="tab_center">
            <span v-for="(item, i) in tabsList" :key="i" class="tab_center_item">
              <a href="#">
                <span>{{ item.text }}</span>
                <span>
                  <img src="../assets/img/999+.png" alt />
                </span>
              </a>
            </span>
          </div>
          ...
          <div class="tab_right">
            <ul>
              <li class="tab_right_item" v-for="(item, i) in tabsRightList" :key="i">
                <a href="#">
                  <i class="iconfont" :class="item.class" :style="item"></i>
  ...
  methods: {
    ...
    async getMainDataList() {
      ...
      for (let i in res.dance) {
        ...
        this.gameList.push(res.dance[i]);
      }
      ...
      for (let i in res.music) {
        ...
        this.gameList.push(res.music[i]);
      }
